...
";
        // line 2
        $context["slug"] = twig_replace_filter((isset($context["slug"]) || array_key_exists("slug", $context) ? $context["slug"] : (function () { throw new RuntimeError('Variable "slug" does not exist.', 2, $this->source); })()), ["-" => " "]);
        // line 3
        echo "
";
        // line 4
        $context["slug"] = twig_title_string_filter($this->env, (isset($context["slug"]) || array_key_exists("slug", $context) ? $context["slug"] : (function () { throw new RuntimeError('Variable "slug" does not exist.', 4, $this->source); })()));
        // line 5
        echo "
...
";
    ...
    {
        return array (  57 => 9,  51 => 5,  49 => 4,  46 => 3,  44 => 2,  41 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("
{% set slug = slug|replace({'-': ' '}) %}
...
<h1>{{ slug }}</h1>
", "blog/show.html.twig", "/home/casey/Documents/quetes/Symfony/blog/templates/blog/show.html.twig");
    }
}
